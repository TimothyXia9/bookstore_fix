...
class Order(models.Model):
    ...
    user = models.ForeignKey(
        UserProfile, related_name="order", on_delete=models.CASCADE, verbose_name="所属用户"
    )
    ...
    payment_method = models.ForeignKey(
        Payment, related_name="order", on_delete=models.DO_NOTHING, verbose_name="支付方式"
    )
    ...
    state = models.CharField(choices=STATE_CHOICES, max_length=5, verbose_name="状态")
